...
function buildPiBodies(pi, stampSrc, baseHref, printProfile) {
  ...
  const pagesHtml = pageSizes
    .map((pageSize, pageIndex) => {
      ...
      <div class="page">
        ...
        ${footerHtml}
        ${pageSizes.length > 1 ? `<div class="doc-page-number">Page ${pageIndex + 1} / ${pageSizes.length}</div>` : ""}
              </div>
      `;
    })
    .join("");
  ...
  const packingPagesHtml = pageSizes
    ...
    const statementPagesHtml = `<div class="page statement-page"><div class="statement-title">STATEMENT COVER</div>
        ...
        <div class="statement-section">
          <div class="statement-heading">Parties Information</div>
        ...
        </div><div class="statement-section"><div class="statement-heading">GENERAL TRANSACTION, DIRECT SHIPMENT & COMPLIANCE TERMS</div></div><div class="statement-section"><div class="statement-heading">1. PARTIES AND COMMERCIAL RELATIONSHIP</div><div>The overseas supplier identified in the applicable Purchase Order, Proforma Invoice, Commercial Invoice or other transaction document (the "Seller") sells the Goods to ${buyerInfo.name} ("JINZA" or the "Buyer").</div><div>The Seller's identity and details may vary from transaction to transaction and shall be determined by the applicable transaction documents.</div><div>JINZA may designate an end customer, consignee or other party as the delivery recipient (the "Designated Recipient").</div><div>The designation of a Designated Recipient does not replace JINZA as the commercial Buyer under the transaction and does not, by itself, create a contractual purchase relationship between the Seller and the Designated Recipient.</div></div><div class="statement-section"><div class="statement-heading">2. PURCHASE ORDER AND SOURCING</div><div>The Seller shall source and supply the Goods according to the product descriptions, specifications, quantities and other requirements stated in the applicable Purchase Order or transaction record issued or approved by JINZA.</div><div>The Goods may be sourced from different manufacturers, suppliers, warehouses or places of origin.</div><div>The Seller may independently arrange such sourcing and consolidation as reasonably necessary to fulfil the applicable Purchase Order, provided that the Goods supplied conform to the agreed transaction requirements.</div><div>A change in sourcing location, manufacturer, consolidation location or logistics arrangement shall not, by itself, alter the agreed price, payment term or delivery obligations.</div></div><div class="statement-section"><div class="statement-heading">3. DIRECT SHIPMENT</div><div>JINZA may instruct the Seller to deliver the Goods directly to a Designated Recipient or delivery location specified by JINZA.</div><div>The Goods may therefore be shipped directly from the Seller, manufacturer, supplier, consolidation warehouse or other place of origin to the Designated Recipient without first being physically received, handled or warehoused by JINZA.</div><div>Such direct shipment shall not alter the contractual purchase relationship between the Seller and JINZA.</div><div>JINZA is not required to take physical possession of the Goods before delivery to the Designated Recipient.</div></div><div class="statement-section"><div class="statement-heading">4. LOGISTICS, CONSOLIDATION AND SUBCONTRACTORS</div><div>The Seller may independently select, appoint, replace or use one or more freight forwarders, logistics providers, consolidation providers, customs agents, importers or other subcontractors according to the origin, location, nature, routing or consolidation requirements of the Goods.</div><div>JINZA's prior approval of individual freight forwarders, logistics providers or subcontractors is not required unless expressly requested by JINZA for a specific transaction.</div><div>The appointment, replacement or use of any such party shall not relieve the Seller of its contractual obligations to JINZA.</div><div>The Seller remains responsible to JINZA for the performance of the sourcing, consolidation, transportation, customs-clearance arrangement and delivery obligations undertaken by or through parties appointed or instructed by the Seller.</div><div>JINZA shall not be required to enter into a separate contractual relationship with, supervise or make direct payment to any such freight forwarder, logistics provider or subcontractor unless separately agreed in writing.</div></div><div class="statement-section"><div class="statement-heading">5. DDP DELIVERY AND FIXED DELIVERED PRICE</div><div>Where DDP is specified in the applicable transaction, the Seller shall arrange delivery of the Goods to the destination designated by JINZA in accordance with the agreed delivery arrangement.</div><div>Unless expressly stated otherwise in the applicable transaction, the agreed DDP price shall constitute the agreed delivered price and include the costs and charges allocated to the Seller under the agreed delivery arrangement, including, where applicable:</div><div>· sourcing and consolidation; · transportation and freight; · customs-clearance arrangements; · applicable import duties and taxes; · logistics charges; and · final delivery to the designated destination.</div><div>The Seller shall not impose additional charges on JINZA solely because of differences or changes in product origin, freight forwarder, logistics provider, routing, consolidation method or customs-clearance arrangement without JINZA's prior written agreement.</div><div>The use of DDP shall not be interpreted as a representation that the Goods are exempt from any mandatory customs, import, licensing, permit, approval, certification, tax or other regulatory requirement.</div></div><div class="statement-section"><div class="statement-heading">6. IMPORTATION AND CUSTOMS ARRANGEMENT</div><div>Under a Seller-arranged DDP direct-shipment transaction, the Seller shall arrange an appropriate and legally compliant importation and customs-clearance structure necessary to complete delivery to the designated destination.</div><div>The applicable importer, customs agent, logistics provider or other responsible party shall determine and comply with the customs and import requirements applicable to the Goods, including, where applicable: customs classification; customs declarations; import licences; permits; approvals; certifications; duties and taxes; and other mandatory import requirements.</div><div>Unless separately agreed in writing for a specific transaction, JINZA does not undertake the role of importer, customs declarant or customs agent and does not participate in the preparation or submission of customs declarations.</div><div>The Seller shall not designate or use JINZA as importer or customs declarant without JINZA's prior written consent.</div><div>Nothing in this Clause requires JINZA, solely in its capacity as commercial Buyer, to independently determine the applicable HS Code, customs classification or import procedure.</div></div><div class="statement-section"><div class="statement-heading">7. CONTROLLED, RESTRICTED AND SENSITIVE GOODS</div><div>Neither the Seller nor any party appointed or instructed by the Seller shall knowingly arrange the importation, customs clearance or delivery of Goods in violation of any applicable prohibition, restriction, licence, permit, approval, certification or other mandatory regulatory requirement.</div><div>Where the Seller, freight forwarder, logistics provider, importer, customs agent or other responsible party identifies that any Goods may be prohibited, restricted, controlled or subject to an unresolved mandatory import or regulatory requirement, the Seller shall notify JINZA and, where reasonably necessary, suspend the affected Goods before proceeding.</div><div>JINZA may place the affected Goods on compliance hold, or may suspend, amend, reject or cancel the affected Goods, where JINZA reasonably identifies an unresolved legal or regulatory compliance concern.</div><div>Where reasonably practicable, such action shall apply only to the affected Goods and shall not unnecessarily delay unrelated Goods in the same transaction.</div><div>The affected Goods may proceed once the relevant compliance issue has been reasonably resolved.</div><div>Neither a Purchase Order issued by JINZA nor any instruction from a Designated Recipient shall constitute an instruction or authorisation to circumvent any applicable customs, import, licensing or regulatory requirement.</div></div><div class="statement-section"><div class="statement-heading">8. ACCURACY OF PRODUCT, CUSTOMS AND REGULATORY INFORMATION</div><div>The Seller shall not knowingly provide, use or instruct another party to provide or use any false, misleading or materially inaccurate product description, customs value, country of origin, customs classification, quantity, specification or other customs or regulatory information.</div><div>No party shall intentionally alter, generalise or misdescribe the Goods for the purpose of avoiding an applicable customs, tax, licensing, permit, certification or regulatory requirement.</div><div>Any customs declaration or customs-related information submitted by the Seller or by a party appointed or instructed by the Seller shall be truthful and accurate as required by applicable law.</div><div>JINZA shall not be required to create, issue, sign or provide customs declarations that are not made by or on behalf of JINZA.</div></div><div class="statement-section"><div class="statement-heading">9. PRODUCT DESCRIPTION AND CLASSIFICATION</div><div>Product descriptions used in the transaction documents shall follow the original commercial source information.</div><div>Where the original product description is in English, the original description shall be preserved.</div><div>Where the original product description is in Chinese, it may be faithfully translated into English without adding, removing or inferring material product characteristics.</div><div>JINZA is not required, solely for the purpose of creating a product record, issuing a Purchase Order or preparing commercial transaction documents, to independently determine or infer: HS Code; customs classification; material composition; intended use; licensing status; certification status; or regulatory classification, where such information has not been provided or independently established.</div><div>Nothing in this Clause permits any party to use an inaccurate, materially incomplete, misleading or deliberately disguised product description.</div></div><div class="statement-section"><div class="statement-heading">10. DESIGNATED RECIPIENT / END-USER INFORMATION</div><div>Where a mandatory licence, permit, approval, registration, certification, declaration or supporting document specifically depends upon the status, intended use, location or regulatory circumstances of the Designated Recipient or end user, the Seller shall notify JINZA of the relevant requirement where identified.</div><div>JINZA may coordinate the provision of reasonably required information or documentation with the relevant customer, Designated Recipient or end user.</div><div>Such cooperation shall not, by itself, transfer the Seller's agreed sourcing, logistics, customs-clearance or DDP delivery obligations to JINZA.</div></div><div class="statement-section"><div class="statement-heading">11. DELIVERY AND RECEIPT CONFIRMATION</div><div>The Goods shall be delivered to the Designated Recipient or delivery location specified by JINZA.</div><div>For transaction completion and reconciliation purposes, delivery shall be considered confirmed when JINZA receives reasonable confirmation from the Designated Recipient or its authorised representative that the Goods have been received.</div><div>Such confirmation may include: signed proof of delivery; receiving record; electronic acknowledgement; written confirmation; email or messaging confirmation; or other reasonable evidence of receipt accepted by JINZA.</div><div>The Seller shall obtain and retain reasonable evidence of delivery and provide such evidence to JINZA upon reasonable request.</div><div>Confirmation of receipt establishes physical delivery for transaction reconciliation purposes but does not constitute a waiver of any subsequently identified shortage, incorrect Goods, damage, latent defect, warranty claim or other substantiated non-conformity.</div></div><div class="statement-section"><div class="statement-heading">12. NON-CONFORMITY, WARRANTY AND CLAIMS</div><div>Where JINZA or the Designated Recipient identifies a material shortage, incorrect Goods, visible damage or other non-conformity, JINZA may notify the Seller within a reasonable period after discovery.</div><div>Claims relating to latent defects shall not be barred solely because the Goods were physically received or delivery was previously confirmed.</div><div>Product-specific warranty periods, technical requirements and remedies shall be determined according to the applicable Purchase Order, agreed product specifications, manufacturer's warranty or other written agreement between the parties.</div><div>The Seller shall reasonably cooperate with JINZA in investigating and resolving substantiated claims, including repair, replacement, credit, refund or other commercially reasonable remedy where applicable.</div></div><div class="statement-section"><div class="statement-heading">13. PAYMENT TERM</div><div>Unless otherwise expressly agreed in writing for a specific transaction:</div><div><strong>Payment shall be made within ninety (90) days from the date of the applicable Packing List (PL).</strong></div><div>The Packing List date shall constitute the contractual starting date of the ninety (90)-day payment period.</div><div>The agreed payment period reflects the commercial arrangement between the parties, including the direct-shipment structure and the time reasonably required by JINZA to obtain receipt confirmation from its Designated Recipient and complete the corresponding transaction verification, reconciliation and settlement process.</div><div>A substantiated dispute concerning non-delivery, material shortage, incorrect Goods, fraud, material non-conformity or an unresolved compliance issue relating to the affected Goods may suspend payment of the genuinely disputed amount pending reasonable resolution.</div><div>Any undisputed amount shall remain subject to the applicable payment term.</div></div><div class="statement-section"><div class="statement-heading">14. SELLER INDEMNITY</div><div>The Seller shall indemnify JINZA against direct losses, penalties, duties, taxes, charges and reasonable costs actually incurred by JINZA to the extent directly resulting from:</div><div>(a) false or materially inaccurate customs or regulatory information knowingly or negligently provided by the Seller or a party appointed or instructed by the Seller;</div><div>(b) failure by the Seller or a party appointed or instructed by the Seller to comply with a mandatory import, customs or regulatory requirement for which the Seller is responsible under these General Terms; or</div><div>(c) acts or omissions of freight forwarders, logistics providers, customs agents or other subcontractors appointed or instructed by the Seller in performing the Seller's agreed contractual obligations.</div><div>This indemnity shall not apply to the extent that the relevant loss directly results from false or materially inaccurate information supplied by JINZA or from an act expressly instructed by JINZA contrary to the Seller's prior written compliance warning.</div><div>Nothing in this Clause shall require the Seller to indemnify JINZA for losses unrelated to the Seller's obligations or conduct under the applicable transaction.</div></div><div class="statement-section"><div class="statement-heading">15. DOCUMENTATION AND RECORD RETENTION</div><div>The Seller shall maintain reasonable commercial, transportation and customs-related records relating to the transaction in accordance with applicable requirements.</div><div>Upon reasonable request, the Seller shall provide reasonably available supporting documentation required by JINZA for: banking verification; accounting; audit; transaction verification; regulatory enquiry; or substantiation of delivery.</div><div>The documents required may vary according to the Goods, transportation arrangement and applicable regulatory requirements.</div><div>Nothing in this Clause requires the Seller to produce a document that is not applicable to the relevant transaction or does not reasonably exist.</div></div><div class="statement-section"><div class="statement-heading">16. STATUS OF DESIGNATED RECIPIENT</div><div>The Designated Recipient acts as the physical recipient of the Goods for delivery purposes.</div><div>Designation as Ship To, Consignee or Designated Recipient shall not, by itself: replace JINZA as the commercial Buyer; establish that the Designated Recipient purchased the Goods directly from the Seller; establish that JINZA physically received or warehoused the Goods; designate JINZA as importer or customs declarant; or conclusively determine the customs or regulatory status of any party.</div><div>The actual customs and regulatory roles shall be determined by the lawful importation and clearance arrangement applicable to the transaction.</div></div><div class="statement-section"><div class="statement-heading">17. COMPLIANCE COOPERATION</div><div>Each party shall provide reasonable cooperation where information within its possession is legitimately required to resolve a customs, regulatory, banking, audit or transaction-verification enquiry relating to the transaction.</div><div>No party shall be required or authorised under these General Terms to make a false declaration, provide materially inaccurate information, conceal or misdescribe the true nature of the Goods, or circumvent a mandatory legal or regulatory requirement.</div></div><div class="statement-section"><div class="statement-heading">18. ACCEPTANCE AND BINDING EFFECT</div><div>These General Terms are issued by ${buyerInfo.name} and are incorporated into and form part of the applicable Purchase Order and related transaction documentation.</div><div>JINZA's issuance of the applicable Purchase Order constitutes JINZA's confirmation of the commercial terms stated therein and its intention to transact on the basis of these General Terms.</div><div>A separate handwritten signature or company stamp of JINZA shall not be required solely to evidence JINZA's issuance of, or intention to be bound by, the applicable Purchase Order and these General Terms.</div><div>The Seller shall be deemed to have accepted and agreed to the applicable Purchase Order and these General Terms upon the earliest occurrence of any of the following:</div><div>(a) signing, stamping, acknowledging or otherwise confirming the Purchase Order or these General Terms;</div><div>(b) issuing or confirming a Proforma Invoice, Commercial Invoice or other transaction document in response to the Purchase Order;</div><div>(c) commencing sourcing, procurement, consolidation, preparation, transportation or shipment of the Goods pursuant to the Purchase Order; or</div><div>(d) otherwise performing any material part of the transaction in accordance with the Purchase Order.</div><div>Where the Seller signs or affixes its company stamp to the applicable transaction documentation, such signature or company stamp shall constitute express evidence of the Seller's acceptance of the applicable Purchase Order and these General Terms.</div><div>Any different or additional standard terms proposed or printed by the Seller on any quotation, Proforma Invoice, Commercial Invoice, Packing List or other document shall not amend, supersede or override these General Terms unless such amendment is expressly agreed to in writing by JINZA.</div><div>The absence of a separate handwritten signature or company stamp of JINZA on the Seller-accepted copy shall not, by itself, invalidate or render ineffective the applicable Purchase Order, these General Terms or the underlying transaction.</div></div><div class="statement-section"><div class="statement-heading">19. TRANSACTION DOCUMENT PACKAGE</div><div>The applicable: Purchase Order (PO); Proforma Invoice (PI); Commercial Invoice (CI); Packing List (PL); and these General Terms may form part of the supporting documentation for the same underlying transaction where identified by the applicable transaction reference.</div><div>For the standard transaction structure:</div><div><strong>Seller:</strong> The overseas supplier identified in the applicable transaction.</div><div><strong>Commercial Buyer:</strong> ${buyerInfo.name}.</div><div><strong>Ship To / Designated Recipient:</strong> The recipient or delivery location designated by JINZA.</div><div>The fact that the Commercial Buyer and Designated Recipient are different parties is consistent with the direct-shipment arrangement and does not, by itself, alter the contractual purchase relationship between the Seller and JINZA.</div></div><div class="statement-section"><div class="statement-heading">20. ORDER OF PRECEDENCE</div><div>In the event of an inconsistency between transaction documents, the following order of precedence shall apply unless JINZA and the Seller expressly agree otherwise in writing:</div><div><strong>(1) expressly agreed transaction-specific terms in the applicable JINZA Purchase Order;</strong></div><div><strong>(2) these General Terms;</strong></div><div><strong>(3) the applicable Proforma Invoice and Commercial Invoice;</strong></div><div><strong>(4) the Packing List and other standard or administrative transaction documents.</strong></div><div>Product description, model, specification, quantity, unit price, currency and other transaction-specific commercial data shall be determined by the applicable transaction record specifically addressing that information.</div><div>A boilerplate or standard term appearing on a Seller-issued quotation, Proforma Invoice, Commercial Invoice, Packing List or other document shall not override these General Terms merely because such document was subsequently issued.</div></div><div class="statement-section"><div class="statement-heading">21. MANDATORY LAW</div><div>Nothing in the Purchase Order, Proforma Invoice, Commercial Invoice, Packing List or these General Terms shall be interpreted as excluding, waiving, avoiding or overriding any mandatory requirement imposed by applicable law or a competent regulatory authority.</div><div>Where a mandatory legal or regulatory requirement conflicts with these General Terms, the mandatory requirement shall prevail to the extent of that conflict.</div></div><div class="statement-section"><div class="statement-heading">22. GOVERNING LAW AND DISPUTE RESOLUTION</div><div>These General Terms and the applicable transaction shall be governed by and construed in accordance with the laws of Malaysia.</div><div>The parties shall first attempt in good faith to resolve any dispute, controversy or claim arising out of or in connection with the applicable transaction through commercial discussions.</div><div>Any dispute, controversy or claim that cannot be resolved amicably shall be referred to and finally resolved by arbitration administered by the <strong>Asian International Arbitration Centre (Malaysia) ("AIAC")</strong> in accordance with the <strong>AIAC Arbitration Rules in force at the time of commencement of the arbitration</strong>.</div><div>The seat of arbitration shall be <strong>Kuala Lumpur, Malaysia</strong>.</div><div>The language of the arbitration shall be <strong>English</strong>.</div><div>The arbitral award shall be final and binding upon the parties.</div></div><div class="statement-section"><div class="statement-heading">23. COMMERCIAL PURPOSE AND SUBSTANCE</div><div>These General Terms document the commercial and operational framework applicable to JINZA's direct-shipment procurement transactions.</div><div>They shall not be interpreted as evidence that JINZA performed an import, customs-declaration, freight-forwarding or customs-agent function where JINZA did not in fact perform such function.</div><div>The actual activities, supporting documents and commercial substance of each transaction shall determine the factual roles performed by the relevant parties.</div><div>The parties acknowledge that a transaction may involve multiple manufacturers, sourcing locations, consolidation points, freight forwarders, logistics providers, import-related service providers or other subcontractors without altering the underlying contractual purchase relationship between the Seller and JINZA.</div></div><div class="statement-section">
          <div class="statement-heading">DOCUMENT ISSUANCE AND SELLER ACCEPTANCE</div>
          <div class="statement-subheading">ISSUED BY</div>
          <div>${buyerInfo.name}</div>
          <div>Purchase Order No.: ${referencePo}</div>
          <div>Issue Date: ${formatDateShort(record.docDate || pi.docDate)}</div>
          <div>This document is issued by ${buyerInfo.name} as part of the applicable transaction documentation. No separate handwritten signature or company stamp of JINZA is required solely for issuance.</div>
        </div><div class="statement-signature">
          <img class="stamp-img" src="${stampSrc}" alt="Company Chop" />
  ...
  const printCss = `
        ...
        * { -webkit-print-color-adjust: exact; print-color-adjust: exact; }
        ...
        .statement-page { font-size: 12px; line-height: 1.25; display: flex; flex-direction: column; min-height: 100vh; }
        .statement-title { text-align: center; font-size: 15px; font-weight: 700; margin: 4px 0 6px; }
        ...
        .statement-section { margin-bottom: 5px; }
        .statement-heading { font-weight: 700; margin-bottom: 4px; }
        .statement-subheading { font-weight: 700; margin: 4px 0 2px; }
        .statement-signature { margin-top: calc(20px + 8ch); display: flex; flex-direction: column; align-items: flex-end; isolation: isolate; width: 100%; }
        ...
        .statement-section { page-break-inside: avoid; break-inside: avoid; }
        @media print {
          body { margin: 24px; }
          thead { display: table-header-group; }
        }
      ...
      `;
  return { pagesHtml, commercialPagesHtml, packingPagesHtml, statementPagesHtml, css: printCss };
}

/* 完整 HTML（window.print 用）：4 份文档连续输出 */
function buildPiPrintHtml(pi, stampSrc, baseHref, printProfile) {
  const b = buildPiBodies(pi, stampSrc, baseHref, printProfile);
  return `
  <html>
    <head>
      <meta charset="UTF-8" />
...
${b.css}
    ...
    <body>
      ${b.pagesHtml}
      ${b.commercialPagesHtml}
      ${b.packingPagesHtml}
      ${b.statementPagesHtml}
    </body>
  </html>
  `;
}

/* 4 份独立文档 HTML（服务端 PDF 分别渲染 + 合并，独立分页 + 独立页码） */
function buildTransactionHtmls(pi, stampSrc, baseHref, printProfile) {
  const b = buildPiBodies(pi, stampSrc, baseHref, printProfile);
...
${b.css}
  ...
  `;
  return {
    piHtml: wrap("Proforma Invoice", b.pagesHtml),
    ciHtml: wrap("Commercial Invoice", b.commercialPagesHtml),
    plHtml: wrap("Packing List", b.packingPagesHtml),
    scHtml: wrap("Statement Cover", b.statementPagesHtml)
  };
}
...
function renderMailRuleList() {
  ...
  const supList = state.data.supplier || [];
  if (rules.length === 0 && supList.length === 0) {
  ...
  if (rules.length) {
    html += '<div style="font-size:12px;color:#64748b;padding:2px 2px 4px;">已配置关联（发送时按 PI 供应商匹配）：</div>' +
      rules.map(rowHtml).join("") + '<div style="height:6px;"></div>';
  }
  const seen = {};
  const cand = [];
  supList.forEach((it) => {
    ...
    if (!code || seen[code]) return;
    seen[code] = 1;
    if (!used[code]) cand.push({ code: code, name: name });
  });
  if (cand.length) {
    html += '<div style="font-size:12px;color:#64748b;padding:2px 2px 4px;">未配置供应商（可点“配置”建立关联）：</div>' +
      cand.map((c) =>
        '<div style="display:flex;align-items:center;gap:8px;background:#fff;border:1px dashed #d5dde8;border-radius:10px;padding:6px 10px;">' +
        '<strong style="min-width:80px;">' + escapeHtml(c.code) + '</strong>' +
...
async function buildTransactionHtmlsForPdf(pi) {
  const baseHref = getPrintBaseHref();
  const record = extractRecord(pi);
  const creditorCode = pi?.printProfileKey || record?.creditorCode || pi?.creditorCode || record?.accNo || "";
  const creditorName = record?.creditorName || pi?.creditorName || "";
  ...
  const stampOverride = profile?.stampDataUrl || profile?.stampPath || "";
  const stampSrc = await getStampSrcWithOverride(stampOverride);
  return buildTransactionHtmls(pi, stampSrc, baseHref, profile);
}
