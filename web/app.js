  ...
  const pagesHtml = pageSizes
    .map((pageSize, pageIndex) => {
      ...
      <div class="page">
        ...
        ${footerHtml}
        <div class="doc-page-number">Page ${pageIndex + 1} of ${pageSizes.length}</div>
      </div>
      `;
    })
    .join("");
