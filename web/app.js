...
function buildPiPrintHtml(pi, stampSrc, baseHref, printProfile) {
  ...
  const statementPagesHtml = `      <div class="page statement-page">
        ...
        </div><div class="statement-page-number statement-page-number-bottom">Page 8 / 8</div></div>`;
