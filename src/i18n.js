...
const messages = {
  ...
  en: {
    ...
    transactions: {
      ...
      successImport: 'Successfully imported {n} transactions',
      confirmImport: 'Confirm Import',
      importPreview: 'Import Preview',
      importing: 'Importing...',
      importNow: 'Import Now',
      transactionDetail: 'Transaction Detail',
      chequeRefNoDesc: 'Bank cheque number or reference code',
      descriptionDesc: 'Transaction description text',
      debitAmountDesc: 'Expense amount (debit)',
      creditAmountDesc: 'Income amount (credit)',
      categoryDesc: 'Choose a category for reporting',
      referencesDesc: 'Optional extended reference fields',
      total: 'Total',
      pending: 'Pending',
      processed: 'Processed',
      all: 'All',
      income: 'Income',
      expense: 'Expense',
      fetchFailed: 'Failed to fetch transaction data, please check network connection or database configuration',
      ...
      supportedFormats: 'Supports .csv files',
      dataPreview: 'Data Preview',
      enterMatchPattern: 'Enter match pattern',
      patternRequired: 'Please enter a valid pattern',
      matchPatternPlaceholder: 'Enter keywords to match...',
      matchTransactions: 'Match Transactions',
      matchingStarted: 'Matching started: {pattern}',
      matchResultsShown: 'Matching results displayed',
      selectItemsToDelete: 'Please select items to delete',
      confirmBatchDelete: 'Confirm batch delete selected items?',
