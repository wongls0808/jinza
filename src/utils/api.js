...
export const userApi = {
  ...
  resetPassword: (id, newPassword) => api.post(`/api/users/${id}/reset-password`, newPassword?{ newPassword }:{}),
  changePassword: (id, body) => api.post(`/api/users/${id}/change-password`, body),
  me: () => api.get('/api/me'),
